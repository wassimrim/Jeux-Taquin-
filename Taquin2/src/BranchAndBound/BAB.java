...
public class BAB {
    ...
    public BAB(Noeud noeudinitial, Noeud noeudfinal) {
    ...
    public void insertionListOuvert(Noeud noeud) {
        ...
        if (this.getListNoeudOuvert().isEmpty()) {
            ...
            OUTER:
            for (i = 0; i < size; i++) {
                if (noeud.getCout() < this.getListNoeudOuvert().elementAt(i).getCout()) {
                    this.listNoeudOuvert.add(i, noeud);
                    break OUTER;
                } else if ((noeud.getCout() == this.getListNoeudOuvert().elementAt(i).getCout()) && (noeud.getHeuristique() < this.getListNoeudOuvert().elementAt(i).getHeuristique())) {
                    this.listNoeudOuvert.add(i, noeud);
                    break OUTER;
                } // lena w9efet
                else if ((noeud.getCout() > this.getListNoeudOuvert().elementAt(i).getCout()) && (this.getListNoeudOuvert().size() - 1 == i)) {
                    this.listNoeudOuvert.add(noeud);
                    break OUTER;
                } else if ((noeud.getCout() == this.getListNoeudOuvert().elementAt(i).getCout()) && (noeud.getHeuristique() >= this.getListNoeudOuvert().elementAt(i).getHeuristique()) && (this.getListNoeudOuvert().size() - 1 == i)) {
                    this.listNoeudOuvert.add(noeud);
                    break OUTER;
                } else if ((noeud.getCout() >= this.getListNoeudOuvert().elementAt(i).getCout()) && (this.getListNoeudOuvert().size() - 2 >= i)) {
                    if ((noeud.getCout() > this.getListNoeudOuvert().elementAt(i).getCout()) && (noeud.getCout() < this.getListNoeudOuvert().elementAt(i + 1).getCout())) {
                        this.listNoeudOuvert.add(i + 1, noeud);
                        break OUTER;
                    } else if ((noeud.getCout() == this.getListNoeudOuvert().elementAt(i).getCout()) && (noeud.getHeuristique() >= this.getListNoeudOuvert().elementAt(i).getHeuristique()) && (noeud.getCout() < this.getListNoeudOuvert().elementAt(i + 1).getCout())) {
                        this.listNoeudOuvert.add(i + 1, noeud);
                        break OUTER;
                    } else if ((noeud.getCout() == this.getListNoeudOuvert().elementAt(i).getCout()) && (noeud.getHeuristique() >= this.getListNoeudOuvert().elementAt(i).getHeuristique()) && (noeud.getCout() == this.getListNoeudOuvert().elementAt(i + 1).getCout())&&(noeud.getHeuristique()< this.getListNoeudOuvert().elementAt(i + 1).getHeuristique()) ) {
                        this.listNoeudOuvert.add(i + 1, noeud);
                        break OUTER;
                    }
                }
